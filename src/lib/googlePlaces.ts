...
export async function getTuristicPlaces(city: string, lang: string) {
  ...
  const headers = {
    ...
    "X-Goog-FieldMask": "places.displayName,places.formattedAddress,places.rating,places.userRatingCount,places.photos,places.id,places.location,places.editorialSummary,places.types",
  };
